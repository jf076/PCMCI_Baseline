...
def get_method_data(
    ...
    """
    Select one method and sort by number of variables N.
    """
...
def plot_rate_with_sem(
    ...
    """
    Plot a percentage-valued metric using mean ± SEM.
    """
...
def plot_pooled_rate(
    ...
    """
    Plot pooled percentage metric without SEM.
    """
...
def format_percentage_axis(
    ...
    """
    Common formatting for rate panels.
    """
...
def plot_orientation_precision(
    ...
    """
    Prefer pooled operational precision.

    pooled precision =
        sum(correct directions)
        -----------------------
...
def plot_runtime(
    ...
    """
    Plot mean runtime with 5%-95% empirical interval.
    """
...
def main():
    ...
    output_png = (
        results_dir
        / "10_variable_count_figure.png"
    )

    output_pdf = (
        results_dir
        / "10_variable_count_figure.pdf"
    )
    ...
    if not summary_path.exists():
        ...
        raise FileNotFoundError(
            "Could not find:\n"
            f"{summary_path}\n\n"
            "Run 09_variable_count_benchmark.py first."
        )
    ...
    fig.suptitle(
        "Runge (2020) Figure 2B-style reproduction\n"
        "T=500, a=0.95, tau_max=5, alpha=0.01",
        fontsize=14,
    )
    ...
    print(
        "\n10 variable-count plotting completed."
    )
